...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='../inputs/DIV2K_valid_HR', help='Input folder')
    parser.add_argument('--output', type=str, default='../inputs/DIV2K_valid_sub', help='Output folder')
    parser.add_argument('--crop_size', type=int, default=1024, help='Crop size')
    parser.add_argument('--step', type=int, default=256, help='Step for overlapped sliding window')
    parser.add_argument(
        '--thresh_size',
        type=int,
        default=0,
